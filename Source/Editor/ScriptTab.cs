...
internal class ScriptTab {
    ...
    [RecordHistory] public int CursorLine { get; set; }

    [RecordHistory] public int CursorChar { get; set; }

    [RecordHistory] public int SelectionStartLine { get; set; } = -1;

    [RecordHistory] public int SelectionStartChar { get; set; } = -1;
